...
-(void)createImage:(UIImageView *)placeImage url:(NSString *)url
{
    ...
    UIImageView *smallIamge = [[UIImageView alloc] init];
    smallIamge.frame = CGRectMake(self.frame.size.width / 2 - 15, self.frame.size.height / 2 - 15, 35, 35);
    smallIamge.image = [UIImage imageNamed:@"1.0.0-user_head"];
    [_imgView addSubview:smallIamge];
}
...

{
    ...
    NSData *data=[_webUrl dataUsingEncoding:NSUTF8StringEncoding];
